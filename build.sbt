...
lazy val pipeline = Project(id = "pipeline", base = file("pipeline"))
...
lazy val datamodel = Project(id = "datamodel", base = file("datamodel"))
...
lazy val ingress = Project(id = "ingress", base = file("ingress"))
